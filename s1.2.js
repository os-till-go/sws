...
const start_text = create_text("Press 'e' to start the game!");
...
if(gameobjects_overlap(player, gameobjects[0])){
      ...
      update_text(start_up_text, "good choice!");
      update_position(start_text1, [300, 55]);
      //game1
    //   if(input_key_down("y")){
    //       //game1
    //       update_text(start_up_text2, "you");
    //   }
    //   if(input_key_down("n")){
    //       update_position(player, [300, 300]);
    //       update_position(start_text1, [1000, 1000]);
    //       update_text(start_text, "welcome to the arcade game box!");
    //       update_text(start_text1, "move your character to a game to start!");
    //   }
}else{
