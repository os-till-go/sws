...
const start_boundry = [create_rectangle(20, 1200), create_rectangle(20, 1200), 
                create_rectangle(1200, 20), create_rectangle(1200, 20)];

const g1 = 3;

update_position(start_boundry[LEFT], [0, 0]);
update_position(start_boundry[UP], [0, 0]);
update_position(start_boundry[RIGHT], [600, 0]);
update_position(start_boundry[DOWN], [0, 600]);
...
const start_background = update_position(update_scale(create_sprite("https://github.com/os-till-go/sws/blob/main/galaxy1.jpg"),[1, 1]), [300, 300]);
